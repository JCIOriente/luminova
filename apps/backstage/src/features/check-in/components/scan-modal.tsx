  ...
  return (
    ...
    >
      <button
        ...
        onClick={onClose}
        className="absolute inset-0 bg-jci-black/70 backdrop-blur-sm"
      />
      <div className="relative flex w-full max-w-md flex-col overflow-hidden rounded-card bg-jci-black text-on-dark-1 shadow-[0_40px_120px_-40px_rgba(0,0,0,0.8)]">
        <div className="flex items-center justify-between gap-3 px-5 pt-4">
          ...
          <div className="flex items-center gap-3">
            <span className="text-[12px] text-on-dark-3 tabular-nums">
