    ...
    <Card as="article" padding="none" className="flex flex-col overflow-hidden">
      <div className={`relative h-28 ${TONE_COVER_BG[tone]}`}>
        ...
        <div className="absolute top-3 left-3 flex flex-col items-center rounded-card bg-surface px-3 py-1.5 shadow-[0_8px_24px_-12px_rgba(19,15,45,0.45)]">
          <span className="font-mono text-ui-2xs tracking-[0.12em] text-ink-3 uppercase">
            {chip.month}
          </span>
      ...
      <div className="flex flex-1 flex-col gap-2 p-5">
        <div className="font-mono text-ui-2xs tracking-[0.12em] text-ink-3 uppercase">
          {CATEGORY_LABELS[activity.category]}
        </div>
        <Link
          to="/activities/$id"
          params={{ id: activity.id }}
          className="text-ui-lg leading-snug font-semibold text-ink-1 underline-offset-4 hover:text-jci-blue hover:underline"
        >
          {activity.title}
        </Link>
        ...
        <div className="mt-1 flex flex-col gap-1.5 text-ui-sm text-ink-2">
        ...
        {director && (
          <div className="mt-auto flex items-center gap-2.5 border-t border-line pt-3">
            ...
            <div className="text-ui-xs text-ink-3">
